...
//
//@Repository
//public class QueryParseAdnimergerRedshiftDao {
//    @Autowired
//    private JdbcTemplate jdbcTemplateAdniRedshift;
//
//    public Response executeSelectQuery(String query) {
//        List<Map<String, Object>> rows = null;
//        String jsonStr = "";
//        try {
//            rows = jdbcTemplateAdniRedshift.queryForList(query);
//        } catch (Exception e) {
...
//        String response = "";
//        try {
//            rows = jdbcTemplateAdniRedshift.update(query);
//        } catch (Exception e) {
...
//        String response = "";
//        try {
//            jdbcTemplateAdniRedshift.update(query);
//        } catch (Exception e) {
//            response = e.getCause().getMessage();
//            return new Response(response, HttpStatus.UNPROCESSABLE_ENTITY);
//        }
