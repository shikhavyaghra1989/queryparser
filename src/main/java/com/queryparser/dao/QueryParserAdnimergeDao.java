...
@Repository
public class QueryParserAdnimergeDao {
    @Autowired
    private JdbcTemplate jdbcTemplateAdniMysql;

    public Response executeSelectQuery(String query) {
        List<Map<String, Object>> rows = null;
        String jsonStr = "";
        try {
            rows = jdbcTemplateAdniMysql.queryForList(query);
        } catch (Exception e) {
    ...
    public Response executeDataManipulationQuery(String query) {
        ...
        String response = "";
        try {
            rows = jdbcTemplateAdniMysql.update(query);
        } catch (Exception e) {
    ...
    public Response executeDataDefinitionQuery(String query) {
        String response = "";
        try {
            jdbcTemplateAdniMysql.update(query);
        } catch (Exception e) {
            response = e.getCause().getMessage();
            return new Response(response, HttpStatus.UNPROCESSABLE_ENTITY);
        }
